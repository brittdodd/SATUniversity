...
namespace SATUniversity.UI.MVC.Controllers
{
    ...
    public class StudentsController : Controller
    {
        ...
        //added prop below for access to the wwroot folder
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StudentId,FirstName,LastName,House,Address,City,State,ZipCode,Phone,Email,PhotoUrl,Ssid,Image")] Student student)
        {
